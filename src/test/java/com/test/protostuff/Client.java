...
public class Client {
    public static void main(String[] args) {
        ...
        SyncRPCClient<RequestPojo, ResponsePojo> client = new SyncRPCClient<RequestPojo, ResponsePojo>( 5,protostuffSerializer,protostuffDeSerializer);
        ...
        try {
            System.out.println(client.call("127.0.0.1",9008,message,10000).getCode());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
